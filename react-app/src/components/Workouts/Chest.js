...
function Chest() {
  ...
  return (
    ...
    <h1 className="workout-header">Chest</h1>
    {!isClicked?
      ...
      <div className="workout-filter">
        ...
        <button className="filter-button" value="assisted" onClick={filterByEquipment}>Assisted</button>
        ...
        <button className="filter-button" value="dumbbell" onClick={filterByEquipment}>Dumbbell</button>
        <button className="filter-button" value="kettlebell" onClick={filterByEquipment}>Kettlebell</button>
        <button className="filter-button" value="stability ball" onClick={filterByEquipment}>Stability Ball</button>
        <button className="filter-button" value="weighted" onClick={filterByEquipment}>Weighted</button>
      </div>
